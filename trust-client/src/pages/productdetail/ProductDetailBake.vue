<template>
    <div style="position: relative;">
                ...
                <div class="ki-item box-flex">
                    <div class="ki-left-wrap">
                        <div class="box-wrap notice-fc">
                            <div class="">
                                <div class="box-num-wrap"><span class="font-big">{{baseInfo.total||""}}</span>分</div>
                            ...
                            <div class="">
                                <div class="box-num-wrap"><span class="font-big">{{baseInfo.max_icome.income}}</span>%</div>
        ...
        <div v-show="fixedNavShow">
            <ul class="scroll-nav-wrap">
                        ...
                        <div class="box-flex box-project-wrap" v-for="(itm, idx) in projLike" :key="idx">
                            <div class="box-project" @click="goProductDetail(itm.id)">
                                ...
                                <div class="box-wrap box-proj-content">
                                    ...
                                    <div class="box-flex">
                                        <div class="box-num-wrap">
                                            <span class="font-big">{{itm.max_icome.income}}</span>%
                                        </div>
                                        <div class="box-wrap font-note profit-tip">
...
export default {
    ...
    mounted() {
        ...
        //         for (let i = 0; i < this.activeStepTop.length; i++) {
        //             const tempTop = document.documentElement.scrollTop;
        //             if (this.activeStepTop[i] <= tempTop < this.activeStepTop[i + 1]) {
        //                 this.activeStep = i;
        //                 return;
        //             }
        //         }
    ...
    computed: {
        ...
        stabTitles() {
            let titles = [];
            let stabItem = this.$store.state.projDetailInfo.info;
            if (stabItem) {
        ...
        isStabShow() {
            let isShow = [];
            let stabItem = this.detailInfo.info;
            for (let i = 0, ilen = stabItem.length; i < ilen; i++) {
        ...
        RadarData() {
            let randarDt = this.$store.state.projBaseInfo.randar;
            let radarData = {
                indicator: [],
                realData: [{
                    value: [],
    ...
    methods: {
        ...
        getDangerTips() {
            let dangerObj = {};
            let info = this.detailInfo ? this.detailInfo.info : {};
...
.product-detail-wrap {
    margin-bottom: 30px;
    padding: 0 12px 30px;
    background: linear-gradient(180deg, rgba(51, 44, 78, 1) 0%, rgba(88, 78, 122, 1) 50%, rgba(59, 51, 91, 1) 100%);
    border-radius: 10px;
